...
public class PantallaNuevoProveedor extends JDialog implements ActionListener {
	...
	public PantallaNuevoProveedor() {
		...
		lblNuevoProveedor.setBounds(0, 11, 534, 25);
		...
		btnAceptar.setIcon(new ImageIcon(PantallaNuevoProveedor.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaNuevoProveedor.class.getResource("/iconos/cerrar-ventana-48px.png")));
