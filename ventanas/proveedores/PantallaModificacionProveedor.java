...
//import logicaSistema.DTO.ProveedoresDTO;
...
public class PantallaModificacionProveedor extends JDialog implements ActionListener {
	...
	public PantallaModificacionProveedor() {
		...
		lblModProveedor.setBounds(0, 11, 534, 25);
		...
		btnAceptar.setIcon(new ImageIcon(PantallaModificacionProveedor.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaModificacionProveedor.class.getResource("/iconos/cerrar-ventana-48px.png")));
