...
public class PantallaBajaProveedor extends JDialog implements ActionListener {
	...
	public PantallaBajaProveedor() {
		...
		lblBajaProveedor.setBounds(0, 11, 534, 25);
		...
		btnAceptar.setIcon(new ImageIcon(PantallaBajaProveedor.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaBajaProveedor.class.getResource("/iconos/cerrar-ventana-48px.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnAceptar) {
			...
			/*if (!chckbxHabilitado.isEnabled()) {
				...
				JOptionPane.showMessageDialog(null, "Debe destildar la opción 'HABILITADO' para darlo de baja",
