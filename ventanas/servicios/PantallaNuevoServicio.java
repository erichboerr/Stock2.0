...
public class PantallaNuevoServicio extends JDialog implements ActionListener {
	...
	public PantallaNuevoServicio() {
		...
		btnAceptar.setIcon(new ImageIcon(PantallaNuevoServicio.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaNuevoServicio.class.getResource("/iconos/cerrar-ventana-48px.png")));
