...
public class PantallaModificacionServicio extends JDialog implements ActionListener {
	...
	public PantallaModificacionServicio() {
		...
		lblTitulo.setBounds(0, 11, 534, 25);
		...
		txtServicio.setToolTipText("Ingrese el nuevo nombre del servicio");
		...
		btnAceptar.setIcon(new ImageIcon(PantallaModificacionServicio.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaModificacionServicio.class.getResource("/iconos/cerrar-ventana-48px.png")));
