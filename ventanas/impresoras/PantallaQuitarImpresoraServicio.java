...
public class PantallaQuitarImpresoraServicio extends JDialog implements ActionListener {
	...
	public PantallaQuitarImpresoraServicio() {
		...
		btnAceptar.setIcon(new ImageIcon(PantallaQuitarImpresoraServicio.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar
				.setIcon(new ImageIcon(PantallaQuitarImpresoraServicio.class.getResource("/iconos/cerrar-ventana-48px.png")));
