...
public class PantallaActualizarSerieImpresora extends JDialog implements ActionListener {
	...
	public PantallaActualizarSerieImpresora() {
		...
		btnAceptar.setIcon(new ImageIcon(PantallaActualizarSerieImpresora.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar
				.setIcon(new ImageIcon(PantallaActualizarSerieImpresora.class.getResource("/iconos/cerrar-ventana-48px.png")));
