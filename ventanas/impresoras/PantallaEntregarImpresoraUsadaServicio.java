...
public class PantallaEntregarImpresoraUsadaServicio extends JDialog implements ActionListener {
	...
	public PantallaEntregarImpresoraUsadaServicio() {
		...
		btnAceptar
				.setIcon(new ImageIcon(PantallaEntregarImpresoraUsadaServicio.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(
				new ImageIcon(PantallaEntregarImpresoraUsadaServicio.class.getResource("/iconos/cerrar-ventana-48px.png")));
