...
public class PantallaBajaImpresora extends JDialog implements ActionListener {
	...
	public PantallaBajaImpresora() {
		...
		btnAceptar.setIcon(new ImageIcon(PantallaBajaImpresora.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar
				.setIcon(new ImageIcon(PantallaBajaImpresora.class.getResource("/iconos/cerrar-ventana-48px.png")));
		...
		if (e.getSource() == btnAceptar) {			
					...
					if (cmbServicio.getSelectedIndex() > 0) {
						if (cmbMarca.getSelectedIndex() > 0) {
							if (cmbModelo.getSelectedIndex() > 0) {
								if (cmbSerie.getSelectedIndex() > 0) {
									/*if (miCoordinador.asignarImpresoraAServicio(cmbServicio, cmbMarca, cmbModelo,
											cmbSerie)) {
										dispose();
							...
							if (cmbModelo.getSelectedIndex() > 0) {
								if (cmbSerie.getSelectedIndex() > 0) {
									/*if (miCoordinador.desasignarImpresoraAServicio(cmbServicio, cmbMarca, cmbModelo,
											cmbSerie)) {
										JOptionPane.showMessageDialog(null, "Impresora desasignada del servicio: "
												+ cmbServicio.getSelectedItem().toString());
										limpiar();
										dispose();
									} else {
						...
						if (cmbMarca.getSelectedIndex() > 0) {
							if (cmbModelo.getSelectedIndex() > 0) {
								if (cmbSerie.getSelectedIndex() > 0) {
									...
									int resp=JOptionPane.showConfirmDialog(null,"Esta seguro de dar de baja la impresora. "+nl+"Es irreversibe la acción de dar de baja");
								          	 /* if (miCoordinador.darDeBajaImpresora(cmbServicio, cmbMarca, cmbModelo, cmbSerie)) {
												...
												JOptionPane.showMessageDialog(null, "No se pudo dada de baja la impresora ",
														"Advertencia", JOptionPane.ERROR_MESSAGE);
											}*/
