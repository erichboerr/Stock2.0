...
public class PantallaSalidaInsumosVarios extends JDialog implements ActionListener {
	...
	public PantallaSalidaInsumosVarios() {
		...
		btnAceptar.setIcon(new ImageIcon(PantallaSalidaInsumosVarios.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnAceptar.setBounds(376, 307, 48, 48);
		getContentPane().add(btnAceptar);
		btnAceptar.addActionListener(this);

		btnCancelar = new JButton("");
		btnCancelar.setIcon(new ImageIcon(PantallaSalidaInsumosVarios.class.getResource("/iconos/cerrar-ventana-48px.png")));
		...
		btnCancelar.setBounds(434, 307, 48, 48);
