...
public class PantallaIngresoInsumosVarios extends JDialog implements ActionListener {
	...
	public PantallaIngresoInsumosVarios() {
		...
		btnAceptar.setIcon(new ImageIcon(PantallaIngresoInsumosVarios.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaIngresoInsumosVarios.class.getResource("/iconos/cerrar-ventana-48px.png")));
