...
public class PantallaNuevosInsumosVarios extends JDialog implements ActionListener {
...
//	CargaComboBox cmb = new CargaComboBox();
	...
	public PantallaNuevosInsumosVarios() {
		...
		btnAceptar.setIcon(new ImageIcon(PantallaNuevosInsumosVarios.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaNuevosInsumosVarios.class.getResource("/iconos/cerrar-ventana-48px.png")));
