...
public class PantallaMarca extends JDialog implements ActionListener {
	...
	public PantallaMarca() {
		...
		lblNuevaMarca.setBounds(0, 11, 454, 25);
		...
		btnAceptar.setIcon(new ImageIcon(PantallaMarca.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaMarca.class.getResource("/iconos/cerrar-ventana-48px.png")));
