...
public class PantallaIngresoInsumos extends JDialog implements ActionListener {
	...
	public PantallaIngresoInsumos() {
		setMinimumSize(new Dimension(380, 510));
		getContentPane().setMinimumSize(new Dimension(380, 500));
		setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
		setTitle("Ingreso de Insumos");
		setPreferredSize(new Dimension(360, 510));
		...
		lblTitulo.setBounds(0, 11, 374, 25);
	...
	//	cmb.cargarCmbProveedor(cmbProveedor);
		...
		btnAceptar.setIcon(new ImageIcon(PantallaIngresoInsumos.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaIngresoInsumos.class.getResource("/iconos/cerrar-ventana-48px.png")));
		...
		btnNuevoInsumo.setIcon(new ImageIcon(PantallaIngresoInsumos.class.getResource("/iconos/a\u00F1adir-48px.png")));
	...
	/*public InsumosDTO miInsumoDTO() {
		...
		miInsumo.setOrdenCompra(txtoc.getText().toUpperCase());
		listaInsumos();
