...
public class PantallaModelo extends JDialog implements ActionListener {
	...
	public PantallaModelo() {
		...
		lblNuevoModelo.setBounds(0, 11, 454, 25);
		...
		btnAceptar.setIcon(new ImageIcon(PantallaModelo.class.getResource("/iconos/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(PantallaModelo.class.getResource("/iconos/cerrar-ventana-48px.png")));
